								...
								<?php if($error){?><div class="errorWrap"><strong>ERROR</strong>:<?php echo htmlentities($error); ?> </div><?php } 
									...
									<table id="zctb" class="display table table-striped table-bordered table-hover" cellspacing="0" width="100%">
										...
										<tbody>
											...
											<?php $sql = "SELECT tblvehicles.VehiclesTitle, brand,tblvehicles.PricePerDay,tblvehicles.FuelType,tblvehicles.ModelYear,tblvehicles.id, tblvehicles.model, tblvehicles.price, tblvehicles.gear_box, tblvehicles.mileage, transmission FROM tblvehicles ORDER BY RegDate ASC;";
												$query = $dbh -> prepare($sql);
												$query->execute();
											...
											<tr>
												...
												<td><a href="sell1.php?id=<?php echo $result->id;?>">
