...
if(strlen($_SESSION['alogin'])==0)
{
	...
	if(isset($_POST['submit']))
	{
		...
		$sql="INSERT INTO tblvehicles(VehiclesTitle,VehiclesBrand,VehiclesOverview, 
			PricePerDay,FuelType,ModelYear,SeatingCapacity,Vimage1,Vimage2,Vimage3,Vimage4,
			Vimage5,AirConditioner,PowerDoorLocks,AntiLockBrakingSystem,BrakeAssist,PowerSteering,
			DriverAirbag,PassengerAirbag,PowerWindows,CDPlayer,CentralLocking,CrashSensor,LeatherSeats, 
			model, price, gear_box, mileage, body_style, type) 
			...
			:crashcensor,:leatherseats,:model, :price, :gear_box, :mileage, :body_style, :type)";
...
<div class="form-group">
	...
	<label class="col-sm-2 control-label">Register Type<span style="color:red">*</span></label>
	<div class="col-sm-4">
...
<div class="form-group">
	...
	<div class="col-sm-4">
		<select class="selectpicker" name="model" required>
		<?php
			$sql = "SELECT * FROM `tblmodel` ORDER BY NAME";
			$query = $dbh -> prepare($sql);
			$query->execute();
			$results=$query->fetchAll(PDO::FETCH_OBJ);
			$cnt=1;
...
<div class="form-group">
	<label class="col-sm-2 control-label">Gear Box<span style="color:red">*</span></label>
	<div class="col-sm-4">
		<select class="selectpicker" name="gear_box" required>
		<?php
			$sql = "SELECT * FROM `tblgear_box` ORDER BY NAME";
			$query = $dbh -> prepare($sql);
			$query->execute();
			$results=$query->fetchAll(PDO::FETCH_OBJ);
			$cnt=1;
...
<div class="form-group">
	...
	<label class="col-sm-2 control-label">Body style<span style="color:red">*</span></label>
	<div class="col-sm-4">
		<select class="selectpicker" name="body_style" required>
		<?php
